  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          >
            ...
            <p className="text-gray-400 leading-relaxed">
              Extract beautiful color palettes from any image with AI-powered precision and speed.
            </p>
        ...
        >
          <p>&copy; 2025 Hexify. All rights reserved. Built with ❤️ for designers and developers.</p>
        </motion.div>
      </div>
    </motion.footer>
  );
